...
// $sql = $conf->fetchall(Student . " where session_name = '".$session."' AND campus = '".$campus."'
//  AND class = '".$class."' AND section_name = '".$section_name."'");
...
// $sql = "SELECT * from ."..".
//         FROM student AS a, class AS c, section AS s, campus AS p, session AS y
//         WHERE a.class = c.class_id
//         WHERE a.section_name = s.section_id
//         WHERE a.campus = p.campus_id
//         WHERE a.session_name = y.session_id
