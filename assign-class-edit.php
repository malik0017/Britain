...
<head>
  ...
  <title><?=SITE_NAME?> |Class Assign to Campus</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"> Class Assign to Campus</h1>
          </div>
          <!-- <div class="float-right mt-3">
        </div> -->
          <div class="col-sm-6 mt-2">  
          <a class="btn btn-warning float-right" href="assign-class-view.php">Back</a>
