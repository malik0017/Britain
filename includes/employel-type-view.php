...
if ( isset( $_POST[ 'deleteid' ] ) ) {
  ...
  $table = EMPLOYETYE. " set `is_deleted`=1  where id='" . $deleteid . "'";
...
$results=$conf->fetchall(EMPLOYETYE." where is_deleted = 0");
 ?>
...
<div class="content">
    ...
    <div class="card-header ">
        ...
        <div class="float-right mt-3">
            <a class="btn btn-warning float-right" href="employel-type-add.php"> Create New Employel Type </a>
        </div>
    </div>
    ...
    <div class="card-body">
        <table id="tabledata" class="table table-bordered table-striped dataTable dtr-inline"
            ...
            <thead class="btn-warning">
                <tr>
                    <th style="width:15%">Employel Type</th>
                    <th style="width:15%">Lunch Allowance</th>
            ...
            <tbody>
               ...
               ?>
                <tr>
                    ...
                    <form action="employel-type-show.php?CD=<?php echo $data->id; ?>" method="post">
                    ...
                    <td>
                    <form action="employel-type-edit.php?CD=<?php echo $data->id; ?>" method="post">
