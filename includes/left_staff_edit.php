...
if ( isset( $_POST[ 'submit' ] ) ) {
 ...
 $account_no = ($_POST[ 'account_no' ]);
  ...
  // , `institute`='" . $institute . "', ` `='" . $passing_year . "', `appointmate_class`='" . $appointmate_class . "'
  // , `confirmation_date`='" . $confirmation_date . "', `IsLeft`= 0 , `transfer_bank`='" . $transfer_bank ."' where id='" . $staff_id . "'";

  $table = STAFF . " set `employel_level`='" . $employel_level . "', `employel_id`='" . $employel_id . "', `employel_name`='" . $employel_name . "',
  `gender`='" . $gender . "', `father_name`='" . $father_name . "', `father_contact`='" . $father_contact . "', `spouse_name`='" . $spouse_name . "',
 `spouse_contact`='" . $spouse_contact . "', `date_birth`='" . $date_birth . "', `jouning_date`='" . $jouning_date . "', `campus`= '" .$campus."', `employel_type`='" . $employel_type . "', `department`='" . $department . "', `shift`='" . $shift . "', `cnic`='" . $cnic . "', 
 `contact`='" . $contact . "', `address`='" . $address . "', `city`='" . $city . "', `salary_type`='" . $salary_type . "', `basic_salary`='" . $basic_salary . "',
 `account_no`='" . $account_no . "',  `travelling_allowane`='" . $travelling_allowane . "',
  `lunch_allowance`='" . $lunch_allowance . "', `other_allowance`='" . $other_allowance . "', `bank_account`='". $bank_account . "',
`grace_time`='" . $grace_time . "', `employel_email`='" . $employel_email . "', `remarks`='" . $remarks . "',
 `employel_image`='" . $employel_image . "', `last_qualification`='" . $last_qualification . "', 
 `institute`='" . $institute . "', `passing_year`='" . $passing_year . "', `appointmate_class`='" . $appointmate_class . "', 
 `confirmation_date`='" . $confirmation_date . "', `IsLeft`= ' 0 '  where id='" . $staff_id . "'";
		...
		if ( $recodes == true ) {
			...
			$gen->redirecttime( 'letf_staff_list.php', '2000' );
		} 
    else {
