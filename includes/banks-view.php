...
if ( isset( $_POST[ 'deleteid' ] ) ) {
  ...
  $table = BANK. " set `is_deleted`=1  where id='" . $deleteid . "'";
...
$results=$conf->fetchall(BANK ." where is_deleted = 0");
 ?>
...
<div class="content">
    ...
    <div class="card-header ">
        ...
        <div class="float-right mt-3">
            <a class="btn btn-warning float-right" href="banks-add.php"> Create New Bank</a>
        </div>
    </div>
        ...
        <table id="tabledata" class="table table-bordered table-striped dataTable dtr-inline"
            ...
            <thead class="btn-warning">
                <tr>
                    ...
                    <th style="width:15%">Bank Logo</th>
...
<form action="banks-show.php?CD=<?php echo $data->id; ?>" method="post">
...
<td>
<form action="banks-edit.php?CD=<?php echo $data->id; ?>" method="post">
