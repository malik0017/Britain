...
if(!$val->isSuccess()){
	...
	if ( empty( $error ) ) {
		...
		$data_post = array( 'campus_type' => $campus_type, 'user_id' => $_SESSION[ 'user_reg' ],'created_at' => $cDateTime);
		$recodes = $conf->insert( $data_post, CAMPUSTYPE );
		if ( $recodes == true ) {
              ...
              <form action="" method="post">
                   <div class="col-lg-4 col-md-4 col-sm-6">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="campus_type" name="campus_type" tabindex="1" placeholder="" required>
                            </div>
