...
if ( isset( $_POST[ 'deleteid' ] ) ) {
  ...
  $table = ACTUALFEE. " set `is_deleted`=1  where id='" . $deleteid . "'";
...
$results=$conf->fetchall(ACTUALFEE ." where is_deleted = 0");
 ?>
...
<div class="content">
    ...
    <div class="card-header ">
        ...
        <div class="float-right mt-3">
            <a class="btn btn-warning float-right" href="actual-fee-add.php"> Create New fee </a>
        </div>
    </div>
    ...
    <div class="card-body">
        <table id="tabledata" class="table table-bordered table-striped dataTable dtr-inline"
            ...
            <thead class="btn-warning">
                <tr>
                    <th style="width:30%">Actual Fee</th>
            ...
            <tbody>
               ...
               ?>
                <tr>
                    ...
                    <form action="actual-fee-show.php?CD=<?php echo $data->id; ?>" method="post">
                    ...
                    <td>
                    <form action="actual-fee-edit.php?CD=<?php echo $data->id; ?>" method="post">
