...
if ( isset( $_POST[ 'deleteid' ] ) ) {
  ...
  $table = SALARY. " set `is_deleted`=1  where id='" . $deleteid . "'";
...
$results=$conf->fetchall(SALARY ." where is_deleted = 0");
 ?>
...
<div class="content">
    ...
    <div class="card-header ">
        ...
        <div class="float-right mt-3">
            <a class="btn btn-warning float-right" href="salary-type-add.php"> Create New Salary Type</a>
        </div>
    </div>
            ...
            <tbody>
               ...
               ?>
                <tr>
                    ...
                    <form action="salary-type-show.php?CD=<?php echo $data->id; ?>" method="post">
                    ...
                    <td>
                    <form action="salary-type-edit.php?CD=<?php echo $data->id; ?>" method="post">
