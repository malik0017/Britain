...
if ( isset( $_POST[ 'submit' ] ) ) {
  ...
  $val->name('Campus type')->value($campus)->pattern('text')->required();
  ...
  if(!$val->isSuccess()){
	...
	if ( empty( $error ) ) {
    $table = ATTENDANCE . " set `campus`='" . $campus . "', `class_name`='" . $class_name . "', `session_name`='" . $session_name . "',
    `section_name`='" . $section_name . "', `teacher_absent`='" . $teacher_absent . "',
     `is_holiday`='" . $holiday . "' where id='" . $atten_id . "'";
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <?php foreach($campus_name as $data){ ?> 
                          <option value="<?php echo $data->id; ?>" <?php if($data->id==$row->campus){ echo "selected";} ?>><?php echo $data->campus_name; ?></option>
                            <?php  }?>                                     
