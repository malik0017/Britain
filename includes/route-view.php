...
if ( isset( $_POST[ 'deleteid' ] ) ) {
  ...
  $table = ROUTE. " set `is_deleted`=1  where id='" . $deleteid . "'";
...
$results=$conf->fetchall(ROUTE. " where is_deleted = 0");
 ?>
...
<div class="content">
    ...
    <div class="card-header ">
        ...
        <div class="float-right mt-3">
            <a class="btn btn-warning float-right" href="route-add.php"> Create New Routes </a>
        </div>
    </div>
    ...
    <div class="card-body">
        <table id="tabledata" class="table table-bordered table-striped dataTable dtr-inline"
            ...
            <thead class="btn-warning">
                <tr>
                    <th style="width:15%">Routes Name</th>
            ...
            <tbody>
               ...
               ?>
                <tr>
                    ...
                    <form action="route-show.php?CD=<?php echo $data->id; ?>" method="post">
                    ...
                    <td>
                    <form action="route-edit.php?CD=<?php echo $data->id; ?>" method="post">
