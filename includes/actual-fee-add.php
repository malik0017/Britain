...
if(!$val->isSuccess()){
	...
	if ( empty( $error ) ) {
		...
		$data_post = array( 'actual_fee' => $actual_fee,
     'user_id' => $_SESSION[ 'user_reg' ],'created_at' => $cDateTime);
		$recodes = $conf->insert( $data_post, ACTUALFEE );
		if ( $recodes == true ) {
                          ...
                          <div class="card-body">
                           <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="actual_fee" name="actual_fee" tabindex="1" placeholder="" required>
                            </div>
                            </div>
                          </div>
                         </div>
