...
// $portrait_header = $_POST[ 'portrait_header' ];
 ...
 //  echo "Noor3333333333".$portrait_footer;
  ...
  $val->name('Campus Address')->value($campus_address)->pattern('words')->required();
  ...
  if(!$val->isSuccess()){
    ...
    $table = CAMPUStbl . " set `campus_type`='" . $campus_type . "', `campus_name`='" . $campus_name . "', `campus_address`='" . $campus_address . "',
     `franchise`='" . $franchise . "',  `campus_logo`='" . $campus_logo . "', `landscape_header`='" . $landscape_header . "',
     `portrait_header`='" . $portrait_header . "', `landscape_footer`='" . $landscape_footer . "', `portrait_footer`='" . $portrait_footer . "', `college`='" . $college . "' where id='" . $campus_id . "'";
		$recodes = $conf->updateValue( $table );

		if ( $recodes == true ) {
			$success = "Record <strong>Updated</strong> Successfully";

			$gen->redirecttime( 'campus-view.php', '2000' );
		} 
    else {
   ...
   $table_fetch = CAMPUStbl . " where id='" . $campus_id . "'";
                ...
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <?php foreach($campus_type as $data){ ?> 
                          <option value="<?php echo $data->id; ?>" <?php if($data->id==$row->campus_type){ echo "selected";} ?>>
                          <?php echo $data->campus_type; ?></option>
                            <?php  }?>                                     
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="campus_name" value="<?php echo $row->campus_name; ?>" name="campus_name" tabindex="2" placeholder="">
                            </div>
                            </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-6">
                           <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="campus_address"  value="<?php echo $row->campus_address; ?>" name="campus_address" tabindex="3" placeholder="">
                        </div>
                         </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 mb-2">
                              <div class="form-group">
                              <label for="campus_logo" class="form-label">Campus Logo </label>
                              <input class="form-control form-controll-style" type="file" id="campus_logo"
                               value="<?php echo $row->campus_logo; ?>"  name="campus_logo" tabindex="4">
                              <img src="upload/campus/<?php echo $row->campus_logo; ?>" alt="" height="100" width="100"/>
                            </div>
                          </div>
                          <div class="col-lg-4 col-md-4 col-sm-6 mb-2">
                            <div class="form-group">
                            <label for="landscape_header" class="form-label">Landscape Header </label>
                            <input class="form-control form-controll-style" type="file" id="landscape_header" value="<?php echo $row->landscape_header; ?>"  name="landscape_header" tabindex="5">
                            <img src="upload/campus/<?php echo $row->landscape_header; ?>" alt="" height="100" width="100"/>
                            </div>
                         </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 mb-2">
                          ...
                          <input class="form-control form-controll-style" type="file" id="portrait_header" value="<?php echo $row->portrait_header; ?>" name="portrait_header" tabindex="6">
                          <img src="upload/campus/<?php echo $row->portrait_header; ?>" alt="" height="100" width="100"/>
                          </div>
                      </div>
                      <div class="col-lg-4 col-md-4 col-sm-6 mb-2">
                        <div class="form-group">
                        <label for="landscape_footer" class="form-label"> Lanscape Footer </label>
                        <input class="form-control form-controll-style" type="file" id="landscape_footer" value="<?php echo $row->landscape_footer; ?>"  name="landscape_footer" tabindex="7">
                        <img src="upload/campus/<?php echo $row->landscape_footer; ?>" alt="" height="100" width="100"/>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                      <div class="form-group">
                      <label for="portrait_footer" class="form-label">Portrait Footer </label>
                      <input class="form-control form-controll-style" type="file" id="portrait_footer" value="<?php echo $row->portrait_footer; ?>" name="portrait_footer" tabindex="8">
                      <img src="upload/campus/<?php echo $row->portrait_footer; ?>" alt="" height="100" width="100"/>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-5 col-md-4 col-sm-6">
                    ...
                    <div class="form-check">
                      <input type="radio" name="franchise" id="is_franchise" value="<?php echo $row->franchise; ?>" tabindex="9" >
                      <label class="form-check-label font-weight-bold   ml-2" for="franchise" > Is Franchise </label>
                    </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 ">
                      <div class="form-check ">
                        <input type="radio" name="college" id="college"  value="<?php echo $row->college; ?>" tabindex="10">
